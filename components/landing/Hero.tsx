...
export function Hero() {
  return (
    <section className="relative bg-[#0F172A] text-white overflow-hidden pt-16">
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[900px] h-[400px] bg-emerald-500/6 rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="relative max-w-4xl mx-auto px-6 pt-20 pb-14 text-center">
        ...
        <p className="text-slate-400 text-lg leading-relaxed mb-10 max-w-2xl mx-auto">
          ...
          profissionais para sua empresa ou escritório jurídico.
        </p>
      ...
      {/* Product screenshot em destaque */}
